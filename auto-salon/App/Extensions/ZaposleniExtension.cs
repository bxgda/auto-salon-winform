...
namespace AutoSalonMac.App.Extensions
{
    ...
    {
        public static ZapolseniTableDTO ToZaposleniTableDTO(this Zaposleni zaposleni)
        {
            return new ZapolseniTableDTO
            {
        ...
        public static Zaposleni ZaposleniTableToEntity(this ZapolseniTableDTO zaposleniDto)
        {
